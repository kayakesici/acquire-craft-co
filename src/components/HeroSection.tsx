...
const HeroSection = () => (
  <section className="relative bg-primary px-6 py-28 md:py-40">
    <div className="mx-auto max-w-3xl text-center">
      ...
      <h1 className="mb-8 text-3xl font-bold leading-tight tracking-tight text-primary-foreground md:text-4xl lg:text-5xl">
        An outsourced M&amp;A function for sourcing, structuring and executing UK SME acquisitions.
      </h1>
      <p className="mx-auto mb-12 max-w-xl text-sm leading-relaxed text-primary-foreground/60 md:text-base">
      ...
      <p className="mt-10 text-xs tracking-wide text-primary-foreground/30">
