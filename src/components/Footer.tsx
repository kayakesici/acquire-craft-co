...
const Footer = () => (
  <footer className="bg-primary px-6 pb-8 pt-0">
    ...
    <div className="mx-auto max-w-[600px] text-center">
      ...
      {/* Row 2 – Disclaimer */}
      <p className="mt-4 max-w-xl mx-auto text-[10px] leading-relaxed text-primary-foreground/35">
      ...
      {/* Row 3 – Navigation */}
      <div className="mt-4 flex items-center justify-center gap-4 text-[11px] text-primary-foreground/35">
